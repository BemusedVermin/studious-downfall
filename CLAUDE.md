...
4. **Iteration order is data, not behaviour.** `System.iteration_order: tuple[Literal["dynamics", "variation", "viability"], ...]` — structural item 7 of the paper's System Description (\S\ref{sec:description}) requires this.
