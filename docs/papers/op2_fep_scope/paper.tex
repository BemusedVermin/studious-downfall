...
\begin{enumerate}[leftmargin=2em,itemsep=4pt]
  ...
  \item \textbf{Codimension (UNPROVEN).} Show that the joint
    block-zero and solenoidal constraints cut out a measure-zero
    submanifold (Aguilera), or that a relaxation recovers positive
    measure (Sakthivadivel; Heins and Da Costa).
