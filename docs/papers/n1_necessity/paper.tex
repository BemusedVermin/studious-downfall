...
\begin{enumerate}[leftmargin=2em,itemsep=4pt]
  ...
  \item \textbf{Essential surjectivity (UNPROVEN).} Prove that for
    every life-producing pair, $\mathrm{Decomp}$ produces a 4-slot
    system whose $O$-observable behaviour matches. This is the
    behaviour-preserving condition the framework actually needs.
...
N1 shares machinery with `op3_topology_universality/` (both invoke
the operad of wiring diagrams) and depends on `c1_closure_unification/`
