...
\begin{enumerate}[leftmargin=2em,itemsep=4pt]
  ...
  \item \textbf{Categorical statement (UNPROVEN).} The cleanest
    formulation uses Dikranjan \& Tholen's categorical closure
    operators; the conjecture is then ``viability is a lax
...
mechanism (`le_level_emergence/`); the two should be coordinated.
